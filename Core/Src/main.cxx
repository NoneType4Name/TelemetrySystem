...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
const unsigned char OV2640_RGB565_MODE[][ 2 ] = {
    { 0xFF, 0x00 },
    { 0xDA, 0x09 },
    { 0xD7, 0x03 },
    { 0xDF, 0x02 },
...
const unsigned char OV2640_SVGA_INIT[][ 2 ] =
    {
        { 0xff, 0x00 },
        { 0x2c, 0xff },
        { 0x2e, 0xdf },
...
uint8_t frameBuffer[ 320 * 240 * 2 ] __attribute__( ( section( ".RAM_D2" ) ) ) __attribute__( ( aligned( 32 ) ) ) { 0 };
...
int main( void )
{
    ...
    HAL_Delay( 10 );
    OV2640_Configuration( OV2640_SVGA_INIT );
    HAL_Delay( 10 );
    OV2640_ResolutionOptions( imgRes );
    HAL_Delay( 10 );
    OV2640_Configuration( OV2640_RGB565_MODE );
    HAL_Delay( 10 );
    ...
    while ( 1 )
    {
        ...
        {
            // bufferPointer = 0;
            OV2640_CaptureSnapshot( ( uint32_t ) frameBuffer, 320 * 240 * 2 );
            // while ( 1 )
            // {
