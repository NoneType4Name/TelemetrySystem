 ...
 * @retval HAL status
 */
HAL_StatusTypeDef __attribute__( ( optimize( "O0" ) ) ) HAL_UART_Receive( UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint32_t Timeout )
{
    uint8_t *pdata8bits;
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef __attribute__( ( optimize( "O0" ) ) ) UART_WaitOnFlagUntilTimeout( UART_HandleTypeDef *huart, uint32_t Flag, FlagStatus Status,
