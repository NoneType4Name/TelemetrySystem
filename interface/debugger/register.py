...
class Optional(metaclass=_UnionMeta):
    pass


class List(metaclass=_UnionMeta):
    pass


class Dict(metaclass=_UnionMeta):
    pass


class Tuple(metaclass=_UnionMeta):
    pass


class Callable(metaclass=_UnionMeta):
    pass


class TypeVar(metaclass=_UnionMeta):
    pass


class Generic(metaclass=_UnionMeta):
    pass
...
def __lldb_init_module(debugger, unused):
    ...
    debugger.HandleCommand(
        "command script import " + os.path.join(parent, "qt6renderer")
    )
